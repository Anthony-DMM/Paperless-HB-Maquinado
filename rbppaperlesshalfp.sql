...
--
-- Base de datos: `rbppaperlesshalfp`
--
...
CREATE DEFINER=`adminpaperless`@`%` PROCEDURE `getOperador_S` ()  NO SQL BEGIN
SELECT empleado.nombre_empleado, empleado.apellido from empleado WHERE empleado.id_proceso=1 and empleado.tipo_usuario='Operador' and empleado.cerrar_orden=1;
END$$
...
CREATE DEFINER=`adminpaperless`@`%` PROCEDURE `llenarRBP` (IN `m` VARCHAR(20), IN `pro` VARCHAR(25), IN `idmo` INT, IN `sec` INT)   BEGIN
...
CREATE DEFINER=`adminpaperless`@`%` PROCEDURE `login` (IN `codsur` VARCHAR(20), OUT `val` INT, OUT `process` VARCHAR(20))   BEGIN    
...
CREATE DEFINER=`adminpaperless`@`%` PROCEDURE `traerInsp` (IN `codkep` VARCHAR(20), OUT `si` INT, IN `proce` VARCHAR(20))  NO SQL begin
DECLARE nom varchar(50);
DECLARE id int;
SET id=(SELECT procesos.id_proceso FROM procesos WHERE procesos.descripcion=proce);
SET nom=(SELECT CONCAT(empleado.nombre_empleado,' ',empleado.apellido) from empleado WHERE empleado.codigo_alea=codkep);
if(nom is null) THEN
set si=0;
ELSE
SELECT CONCAT(empleado.nombre_empleado,' ',empleado.apellido) as nomcompl from empleado WHERE empleado.codigo_alea=codkep;
...
CREATE DEFINER=`adminpaperless`@`%` PROCEDURE `traerKeeper` (IN `codkep` VARCHAR(20), OUT `si` INT, IN `proce` VARCHAR(20))  NO SQL begin
DECLARE nom varchar(50);
DECLARE id int;
...
INSERT INTO `das` (`id_das`, `linea`, `empleado_id_empleado`, `id_keeper`, `id_inspector`, `fecha`, `activaSupervisor`, `activaOperador`, `turno`, `proceso`) VALUES
(1, 'TP08', 737, 737, 737, '2020-10-30', 1, 1, 0, 'PRENSA'),
(2, 'TP08', 737, 737, 737, '2020-10-30', 1, 0, 1, 'PRENSA'),
(3, 'TP08', 758, 758, 758, '2020-10-30', 1, 1, 1, 'PRENSA'),
(4, 'TP08', 758, 758, 758, '2020-10-30', 1, 0, 0, 'PRENSA'),
(5, 'TP08', 758, 758, 758, '2020-11-02', 1, 1, 1, 'PRENSA'),
(6, 'TP08', 745, 745, 745, '2020-11-02', 1, 1, 0, 'PRENSA'),
(7, 'TP08', 745, 745, 745, '2020-11-02', 1, 1, 1, 'PRENSA'),
(8, 'TP08', 758, 758, 758, '2020-11-02', 1, 1, 0, 'PRENSA'),
(9, 'TP08', 745, 745, 745, '2020-11-02', 1, 1, 0, 'PRENSA'),
(10, 'TP08', 745, 745, 745, '2020-11-02', 1, 1, 1, 'PRENSA'),
(11, 'TP01', 600, 600, 600, '2020-11-02', 1, 1, 2, 'PRENSA'),
(12, 'TP03', 753, 753, 753, '2020-11-03', 1, 1, 1, 'PRENSA'),
(13, 'TP03', 753, 753, 753, '2020-11-03', 1, 1, 0, 'PRENSA'),
(14, 'TP03', 753, 753, 753, '2020-11-03', 1, 1, 0, 'PRENSA'),
(15, 'TP03', 753, 753, 753, '2020-11-03', 1, 0, 1, 'PRENSA'),
(16, 'TP03', 756, 756, 756, '2020-11-03', 1, 1, 0, 'PRENSA'),
(17, 'TP03', 756, 756, 756, '2020-11-03', 1, 1, 1, 'PRENSA'),
(18, 'TP03', 756, 756, 756, '2020-11-03', 1, 1, 1, 'PRENSA'),
(19, 'TP01', 745, 745, 745, '2020-11-04', 1, 1, 1, 'PRENSA'),
(20, 'TP01', 145, 145, 145, '2020-11-04', 1, 1, 0, 'PRENSA'),
(21, 'TP01', 145, 145, 145, '2020-11-04', 1, 0, 1, 'PRENSA'),
(22, 'TP01', 745, 745, 745, '2020-11-04', 1, 1, 0, 'PRENSA'),
(23, 'TP01', 145, 145, 145, '2020-11-04', 1, 1, 0, 'PRENSA'),
(24, 'TP01', 145, 145, 145, '2020-11-04', 1, 1, 1, 'PRENSA'),
(25, 'TP03', 742, 742, 742, '2020-11-04', 1, 1, 0, 'PRENSA'),
(26, 'TP03', 742, 742, 742, '2020-11-04', 1, 1, 1, 'PRENSA'),
(27, 'TP05', 746, 746, 746, '2020-11-05', 1, 1, 1, 'PRENSA'),
(28, 'TP05', 746, 746, 746, '2020-11-05', 1, 1, 0, 'PRENSA'),
(29, 'TP05', 149, 149, 149, '2020-11-05', 1, 1, 0, 'PRENSA'),
(30, 'TP05', 149, 149, 149, '2020-11-05', 1, 1, 1, 'PRENSA'),
(31, 'TP01', 745, 745, 745, '2020-11-06', 1, 1, 0, 'PRENSA'),
(32, 'TP01', 745, 745, 745, '2020-11-06', 1, 1, 1, 'PRENSA'),
(33, 'TP01', 145, 145, 145, '2020-11-06', 1, 1, 0, 'PRENSA'),
(34, 'TP01', 145, 145, 145, '2020-11-06', 1, 1, 1, 'PRENSA'),
(35, 'TP05', 149, 149, 149, '2020-11-10', 1, 1, 0, 'PRENSA'),
(36, 'TP05', 149, 149, 149, '2020-11-10', 1, 1, 1, 'PRENSA'),
(37, 'TP05', 739, 739, 739, '2020-11-10', 1, 1, 0, 'PRENSA'),
(38, 'TP05', 739, 739, 739, '2020-11-10', 1, 0, 1, 'PRENSA'),
(39, 'TP01', 145, 145, 145, '2020-11-10', 1, 1, 0, 'PRENSA'),
(40, 'TP01', 145, 145, 145, '2020-11-10', 1, 1, 2, 'PRENSA'),
(41, 'TP03', 174, 174, 174, '2020-11-10', 1, 1, 0, 'PRENSA'),
(42, 'TP03', 174, 174, 174, '2020-11-10', 1, 1, 2, 'PRENSA'),
(43, 'TP04', 737, 737, 737, '2020-11-11', 1, 1, 0, 'PRENSA'),
(44, 'TP04', 737, 737, 737, '2020-11-11', 1, 1, 1, 'PRENSA'),
(45, 'TP05', 749, 749, 749, '2020-11-12', 1, 1, 0, 'PRENSA'),
(46, 'TP05', 749, 749, 749, '2020-11-12', 1, 0, 1, 'PRENSA'),
(47, 'TP07', 734, 734, 734, '2020-11-13', 1, 1, 0, 'PRENSA'),
(48, 'TP07', 734, 734, 734, '2020-11-13', 1, 1, 1, 'PRENSA'),
(49, 'TP07', 740, 740, 740, '2020-11-13', 1, 1, 0, 'PRENSA'),
(50, 'TP07', 740, 740, 740, '2020-11-13', 1, 1, 1, 'PRENSA'),
(51, 'TP10', 752, 752, 752, '2020-11-17', 1, 1, 0, 'PRENSA'),
(52, 'TP10', 752, 752, 752, '2020-11-17', 1, 1, 1, 'PRENSA'),
(53, 'TP10', 746, 746, 746, '2020-11-19', 1, 1, 1, 'PRENSA'),
(54, 'TP01', 145, 145, 145, '2020-11-19', 1, 1, 1, 'PRENSA'),
(55, 'TP10', 746, 746, 746, '2020-11-19', 1, 1, 0, 'PRENSA'),
(56, 'TP01', 145, 145, 145, '2020-11-19', 1, 1, 0, 'PRENSA'),
(57, 'TP01', 149, 149, 149, '2020-11-21', 1, 1, 1, 'PRENSA'),
(58, 'TP01', 149, 149, 149, '2020-11-21', 1, 1, 0, 'PRENSA'),
(59, 'TP41', 148, 148, 148, '2020-11-21', 1, 1, 0, 'PRENSA'),
(60, 'TP41', 148, 148, 148, '2020-11-21', 1, 1, 1, 'PRENSA'),
(61, 'TP01', 145, 145, 145, '2020-11-21', 1, 1, 1, 'PRENSA'),
(62, 'TP01', 145, 145, 145, '2020-11-21', 1, 1, 0, 'PRENSA'),
(63, 'TP41', 739, 739, 739, '2020-11-23', 1, 1, 0, 'PRENSA'),
(64, 'TP41', 739, 739, 739, '2020-11-23', 1, 0, 1, 'PRENSA'),
(65, 'TP41', 148, 148, 148, '2020-11-23', 1, 1, 0, 'PRENSA'),
(66, 'TP41', 148, 148, 148, '2020-11-23', 1, 1, 1, 'PRENSA'),
(67, 'TP03', 753, 753, 753, '2020-11-24', 1, 1, 0, 'PRENSA'),
(68, 'TP03', 753, 753, 753, '2020-11-24', 1, 0, 1, 'PRENSA'),
(69, 'TP03', 756, 756, 756, '2020-11-24', 1, 1, 0, 'PRENSA'),
(70, 'TP03', 756, 756, 756, '2020-11-24', 1, 0, 1, 'PRENSA'),
(71, 'TP10', 169, 169, 169, '2020-11-25', 1, 1, 1, 'PRENSA'),
(72, 'TP10', 169, 169, 169, '2020-11-25', 1, 1, 0, 'PRENSA'),
(73, 'TP02', 170, 170, 170, '2020-11-30', 1, 1, 0, 'PRENSA'),
(74, 'TP02', 170, 170, 170, '2020-11-30', 1, 1, 1, 'PRENSA'),
(75, 'TP02', 148, 148, 148, '2020-11-30', 1, 1, 0, 'PRENSA'),
(76, 'TP02', 148, 148, 148, '2020-11-30', 1, 1, 1, 'PRENSA'),
(77, 'TP09', 755, 755, 755, '2020-12-02', 1, 1, 0, 'PRENSA'),
(78, 'TP09', 755, 755, 755, '2020-12-02', 1, 1, 1, 'PRENSA'),
(79, 'TP09', 747, 747, 747, '2020-12-02', 1, 1, 0, 'PRENSA'),
(80, 'TP09', 747, 747, 747, '2020-12-02', 1, 1, 1, 'PRENSA'),
(81, 'TP04', 745, 745, 745, '2020-12-07', 1, 1, 0, 'PRENSA'),
(82, 'TP04', 745, 745, 745, '2020-12-07', 1, 0, 1, 'PRENSA'),
(83, 'TP04', 748, 748, 748, '2020-12-07', 1, 1, 0, 'PRENSA'),
(84, 'TP04', 748, 748, 748, '2020-12-07', 1, 0, 1, 'PRENSA'),
(85, 'TP01', 170, 170, 170, '2020-12-08', 1, 1, 1, 'PRENSA'),
(86, 'TP41', 752, 752, 752, '2020-12-08', 1, 1, 0, 'PRENSA'),
(87, 'TP41', 752, 752, 752, '2020-12-08', 1, 0, 1, 'PRENSA'),
(88, 'TP41', 738, 738, 738, '2020-12-08', 1, 1, 0, 'PRENSA'),
(89, 'TP41', 738, 738, 738, '2020-12-08', 1, 0, 1, 'PRENSA'),
(90, 'TP09', 755, 755, 755, '2020-12-09', 1, 1, 0, 'PRENSA'),
(91, 'TP09', 755, 755, 755, '2020-12-09', 1, 0, 1, 'PRENSA'),
(92, 'TP09', 747, 747, 747, '2020-12-09', 1, 1, 0, 'PRENSA'),
(93, 'TP09', 747, 747, 747, '2020-12-09', 1, 1, 1, 'PRENSA'),
(94, 'TP09', 755, 755, 755, '2020-12-09', 1, 1, 0, 'PRENSA'),
(95, 'TP09', 755, 755, 755, '2020-12-09', 1, 1, 1, 'PRENSA'),
(96, 'TP05', 739, 739, 739, '2020-12-10', 1, 1, 0, 'PRENSA'),
(97, 'TP05', 739, 739, 739, '2020-12-10', 1, 0, 1, 'PRENSA'),
(98, 'TP05', 739, 739, 739, '2020-12-10', 1, 1, 1, 'PRENSA'),
(99, 'TP05', 739, 739, 739, '2020-12-10', 1, 0, 0, 'PRENSA'),
(100, 'TP02', 740, 740, 740, '2020-12-11', 1, 1, 1, 'PRENSA'),
(101, 'TP02', 740, 740, 740, '2020-12-11', 1, 1, 0, 'PRENSA'),
(102, 'TP02', 740, 740, 740, '2020-12-11', 1, 0, 1, 'PRENSA'),
(103, 'TP02', 740, 740, 740, '2020-12-11', 1, 0, 0, 'PRENSA'),
(104, 'TP04', 738, 738, 738, '2020-12-16', 1, 1, 0, 'PRENSA'),
(105, 'TP04', 738, 738, 738, '2020-12-16', 1, 0, 1, 'PRENSA'),
(106, 'TP41', 740, 740, 740, '2020-12-18', 1, 1, 1, 'PRENSA'),
(107, 'TP41', 740, 740, 740, '2020-12-18', 1, 0, 0, 'PRENSA'),
(108, 'TP05', 746, 746, 746, '2021-01-05', 1, 1, 0, 'PRENSA'),
(109, 'TP05', 746, 746, 746, '2021-01-05', 1, 1, 1, 'PRENSA'),
(110, 'TP10', 757, 757, 757, '2021-01-05', 1, 1, 0, 'PRENSA'),
(111, 'TP10', 757, 757, 757, '2021-01-05', 1, 0, 1, 'PRENSA'),
(112, 'TP05', 738, 738, 738, '2021-01-06', 1, 1, 0, 'PRENSA'),
(113, 'TP05', 738, 738, 738, '2021-01-06', 1, 0, 1, 'PRENSA'),
(114, 'TP09', 747, 747, 747, '2021-01-08', 1, 1, 0, 'PRENSA'),
(115, 'TP09', 747, 747, 747, '2021-01-08', 1, 0, 1, 'PRENSA'),
(117, 'TP41', 738, 738, 738, '2021-01-13', 1, 0, 1, 'PRENSA'),
(119, 'TP41', 738, 738, 738, '2021-01-13', 1, 0, 1, 'PRENSA'),
(120, 'TP03', 742, 742, 742, '2021-01-14', 1, 1, 0, 'PRENSA'),
(121, 'TP03', 742, 742, 742, '2021-01-14', 1, 0, 1, 'PRENSA'),
(122, 'TP02', 174, 174, 174, '2021-01-14', 1, 1, 0, 'PRENSA'),
(123, 'TP02', 174, 174, 174, '2021-01-14', 1, 0, 1, 'PRENSA'),
(124, 'TP01', 746, 746, 746, '2021-01-15', 1, 1, 0, 'PRENSA'),
(125, 'TP01', 746, 746, 746, '2021-01-15', 1, 0, 1, 'PRENSA'),
(126, 'TP03', 755, 755, 755, '2021-01-15', 1, 1, 0, 'PRENSA'),
(127, 'TP03', 755, 755, 755, '2021-01-15', 1, 0, 1, 'PRENSA'),
(128, 'TP01', 753, 753, 753, '2021-01-18', 1, 1, 0, 'PRENSA'),
(129, 'TP01', 753, 753, 753, '2021-01-18', 1, 0, 1, 'PRENSA'),
(130, 'TP02', 174, 174, 174, '2021-01-18', 1, 1, 0, 'PRENSA'),
(131, 'TP02', 174, 174, 174, '2021-01-18', 1, 0, 1, 'PRENSA'),
(132, 'TP11', 740, 740, 740, '2021-01-21', 1, 1, 0, 'PRENSA'),
(133, 'TP11', 740, 740, 740, '2021-01-21', 1, 0, 1, 'PRENSA'),
(134, 'TP11', 735, 735, 735, '2021-01-21', 1, 1, 0, 'PRENSA'),
(135, 'TP11', 735, 735, 735, '2021-01-21', 1, 0, 1, 'PRENSA'),
(136, 'TP09', 755, 755, 755, '2021-01-22', 1, 1, 0, 'PRENSA'),
(137, 'TP09', 755, 755, 755, '2021-01-22', 1, 0, 1, 'PRENSA'),
(138, 'TP10', 743, 743, 743, '2021-01-22', 1, 1, 0, 'PRENSA'),
(139, 'TP10', 743, 743, 743, '2021-01-22', 1, 0, 1, 'PRENSA'),
(140, 'TP02', 746, 746, 746, '2021-01-27', 1, 1, 0, 'PRENSA'),
(141, 'TP02', 746, 746, 746, '2021-01-27', 1, 0, 1, 'PRENSA'),
(142, 'TP04', 740, 740, 740, '2021-01-27', 1, 1, 0, 'PRENSA'),
(143, 'TP04', 740, 740, 740, '2021-01-27', 1, 0, 1, 'PRENSA'),
(144, 'TP09', 756, 756, 756, '2021-02-18', 1, 1, 0, 'PRENSA'),
(145, 'TP09', 756, 756, 756, '2021-02-18', 1, 0, 1, 'PRENSA'),
(146, 'TP02', 747, 747, 747, '2021-02-18', 1, 1, 0, 'PRENSA'),
(147, 'TP02', 747, 747, 747, '2021-02-18', 1, 0, 1, 'PRENSA'),
(148, 'TP11', 740, 740, 740, '2021-02-24', 1, 1, 0, 'PRENSA'),
(149, 'TP11', 740, 740, 740, '2021-02-24', 1, 0, 1, 'PRENSA'),
(150, 'TP01', 745, 745, 745, '2021-04-19', 1, 1, 0, 'PRENSA'),
(151, 'TP01', 745, 745, 745, '2021-04-19', 1, 0, 1, 'PRENSA'),
(152, 'TP01', 169, 169, 169, '2021-06-14', 1, 1, 1, 'PRENSA'),
(153, 'TP01', 169, 169, 169, '2021-06-14', 1, 1, 1, 'PRENSA'),
(154, 'TP01', 169, 169, 169, '2021-06-14', 1, 1, 0, 'PRENSA'),
(155, 'TP01', 169, 169, 169, '2021-06-14', 1, 1, 1, 'PRENSA'),
(156, 'TP05', 758, 758, 758, '2021-06-15', 1, 1, 0, 'PRENSA'),
(157, 'TP05', 758, 758, 758, '2021-06-15', 1, 1, 1, 'PRENSA'),
(158, 'TP02', 745, 745, 745, '2021-06-15', 1, 1, 0, 'PRENSA'),
(159, 'TP02', 745, 745, 745, '2021-06-15', 1, 1, 1, 'PRENSA'),
(160, 'TP02', 745, 745, 745, '2021-06-15', 1, 1, 0, 'PRENSA'),
(161, 'TP02', 745, 745, 745, '2021-06-15', 1, 0, 1, 'PRENSA'),
(162, 'TP08', 738, 738, 738, '2021-06-17', 1, 1, 1, 'PRENSA'),
(163, 'TP01', 745, 745, 745, '2021-06-21', 1, 1, 0, 'PRENSA'),
(164, 'TP01', 745, 745, 745, '2021-06-21', 1, 0, 2, 'PRENSA'),
(165, 'TP04', 748, 746, 746, '2021-06-22', 1, 1, 0, 'PRENSA'),
(166, 'TP04', 746, 746, 746, '2021-06-22', 1, 0, 2, 'PRENSA'),
(167, 'TP02', 741, 741, 741, '2021-06-24', 1, 1, 0, 'PRENSA'),
(168, 'TP02', 741, 741, 741, '2021-06-24', 1, 0, 2, 'PRENSA'),
(169, 'TP11', 753, 753, 753, '2021-06-30', 1, 1, 0, 'PRENSA'),
(170, 'TP11', 753, 753, 753, '2021-06-30', 1, 0, 1, 'PRENSA'),
(171, 'TP10', 758, 758, 758, '2021-07-21', 1, 1, 0, 'PRENSA'),
(172, 'TP10', 758, 758, 758, '2021-07-21', 1, 0, 1, 'PRENSA'),
(173, 'TP10', 758, 758, 758, '2021-07-22', 1, 1, 0, 'PRENSA'),
(174, 'TP10', 758, 758, 758, '2021-07-22', 1, 0, 1, 'PRENSA'),
(175, 'TH02', 66, 66, 66, '2021-08-03', 1, 0, 1, 'MAQUINADO'),
(176, 'TH13', 69, 69, 69, '2021-08-04', 1, 0, 1, 'MAQUINADO'),
(177, 'TH02', 42, 42, 42, '2021-08-06', 1, 0, 1, 'MAQUINADO'),
(178, 'TH12', 35, 35, 35, '2021-08-10', 1, 1, 2, 'MAQUINADO'),
(179, 'TH11', 47, 49, 49, '2021-08-10', 1, 0, 2, 'MAQUINADO'),
(180, 'TH13', 27, 27, 27, '2021-08-10', 1, 1, 2, 'MAQUINADO'),
(181, 'TH03', 131, 34, 131, '2021-08-18', 1, 1, 1, 'MAQUINADO'),
(182, 'TH03', 131, 34, 34, '2021-08-18', 1, 0, 1, 'MAQUINADO'),
(183, 'TP02', 756, 756, 756, '2021-08-19', 1, 1, 2, 'PRENSA'),
(184, 'TP02', 756, 756, 756, '2021-08-19', 1, 1, 0, 'PRENSA'),
(185, 'TH10', 42, 42, 42, '2021-08-19', 1, 1, 1, 'MAQUINADO'),
(186, 'TH06', 37, 122, 122, '2021-08-20', 1, 1, 1, 'MAQUINADO'),
(187, 'TH06', 122, 122, 122, '2021-08-20', 1, 0, 1, 'MAQUINADO'),
(188, 'TH06', 123, 66, 122, '2021-08-20', 1, 1, 1, 'MAQUINADO'),
(189, 'TH17', 58, 66, 30, '2021-08-20', 1, 1, 1, 'MAQUINADO'),
(190, 'TH12', 66, 66, 122, '2021-08-20', 1, 1, 1, 'MAQUINADO'),
(191, 'TP41', 747, 747, 747, '2021-08-24', 1, 0, 1, 'PRENSA'),
(192, 'TP41', 741, 741, 741, '2021-08-24', 1, 0, 1, 'PRENSA'),
(193, 'TP11', 745, 745, 745, '2021-08-25', 1, 1, 0, 'PRENSA'),
(194, 'TP11', 745, 745, 745, '2021-08-25', 1, 1, 1, 'PRENSA'),
(195, 'TP05', 174, 148, 148, '2021-08-25', 1, 1, 0, 'PRENSA'),
(196, 'TP05', 148, 148, 148, '2021-08-25', 1, 1, 2, 'PRENSA'),
(197, 'TH05', 66, 66, 66, '2021-08-26', 1, 0, 2, 'MAQUINADO'),
(198, 'TH14', 69, 69, 69, '2021-08-26', 1, 1, 1, 'MAQUINADO'),
(199, 'TP11', 745, 745, 745, '2021-08-26', 1, 1, 0, 'PRENSA'),
(200, 'TP11', 745, 745, 745, '2021-08-26', 1, 0, 1, 'PRENSA'),
(201, 'TP01', 757, 757, 757, '2021-08-26', 1, 0, 1, 'PRENSA'),
(202, 'TP08', 170, 170, 170, '2021-08-26', 1, 1, 1, 'PRENSA'),
(203, 'TH10', 131, 53, 131, '2021-08-26', 1, 1, 1, 'MAQUINADO'),
(204, 'TH10', 131, 53, 131, '2021-08-26', 1, 1, 1, 'MAQUINADO'),
(205, 'TH05', 35, 42, 35, '2021-08-27', 1, 0, 2, 'MAQUINADO'),
(206, 'TP08', 738, 756, 756, '2021-08-27', 1, 1, 0, 'PRENSA'),
(207, 'TP08', 756, 756, 756, '2021-08-27', 1, 0, 1, 'PRENSA'),
(208, 'TP41', 148, 148, 148, '2021-08-27', 1, 0, 1, 'PRENSA'),
(209, 'TP01', 750, 750, 750, '2021-08-27', 1, 0, 1, 'PRENSA'),
(210, 'TP10', 752, 752, 752, '2021-08-27', 1, 1, 1, 'PRENSA'),
(211, 'TP04', 737, 743, 743, '2021-08-30', 1, 1, 0, 'PRENSA'),
(212, 'TP04', 743, 743, 743, '2021-08-30', 1, 0, 1, 'PRENSA'),
(213, 'TP04', 744, 744, 744, '2021-08-30', 1, 0, 2, 'PRENSA'),
(214, 'TP41', 740, 740, 740, '2021-08-30', 1, 0, 2, 'PRENSA'),
(215, 'TH07', 42, 42, 48, '2021-08-31', 1, 0, 1, 'MAQUINADO'),
(216, 'TH02', 131, 27, 131, '2021-09-02', 1, 0, 1, 'MAQUINADO'),
(217, 'TP09', 174, 755, 755, '2021-09-21', 1, 1, 0, 'PRENSA'),
(218, 'TP09', 755, 755, 755, '2021-09-21', 1, 0, 1, 'PRENSA'),
(219, 'TP08', 735, 735, 735, '2021-09-21', 1, 0, 1, 'PRENSA'),
(220, 'TP03', 735, 735, 735, '2021-09-21', 1, 0, 2, 'PRENSA'),
(221, 'TP03', 751, 751, 751, '2021-09-21', 1, 1, 2, 'PRENSA'),
(222, 'TP01', 755, 753, 753, '2021-09-22', 1, 1, 0, 'PRENSA'),
(223, 'TP01', 753, 753, 753, '2021-09-22', 1, 0, 1, 'PRENSA'),
(224, 'TP04', 174, 174, 174, '2021-09-22', 1, 0, 1, 'PRENSA'),
(225, 'TP09', 746, 746, 746, '2021-09-23', 1, 1, 0, 'PRENSA'),
(226, 'TP09', 746, 746, 746, '2021-09-23', 1, 1, 1, 'PRENSA'),
(227, 'TH42', 37, 2, 37, '2021-09-28', 1, 1, 1, 'MAQUINADO'),
(228, 'TP05', 752, 752, 752, '2021-09-28', 1, 1, 0, 'PRENSA'),
(229, 'TP05', 752, 752, 752, '2021-09-28', 1, 1, 1, 'PRENSA'),
(230, 'TH17', 122, 36, 129, '2021-09-29', 1, 0, 1, 'MAQUINADO'),
(231, 'TH17', 31, 36, 48, '2021-09-29', 1, 0, 1, 'MAQUINADO'),
(232, 'TH17', 58, 2, 58, '2021-10-12', 1, 1, 1, 'MAQUINADO'),
(233, 'TH17', 58, 2, 58, '2021-10-12', 1, 1, 1, 'MAQUINADO'),
(234, 'TH17', 58, 2, 58, '2021-10-12', 1, 1, 1, 'MAQUINADO'),
(235, 'th10', 28, 45, 54, '2022-05-19', 1, 1, 1, 'MAQUINADO'),
(236, 'TH10', 28, 28, 28, '2022-05-19', 1, 1, 1, 'MAQUINADO'),
(237, 'TH10', 28, 45, 45, '2022-05-20', 1, 1, 1, 'MAQUINADO'),
(238, 'TH10', 45, 45, 45, '2022-05-23', 1, 1, 1, 'MAQUINADO'),
(239, 'TH10', 34, 34, 34, '2022-05-23', 1, 1, 1, 'MAQUINADO'),
(240, 'TG01', 701, 701, 701, '2022-05-24', 1, 1, 2, 'T. SUPERFICIES'),
(241, 'TH10', 28, 28, 28, '2022-05-25', 1, 1, 1, 'MAQUINADO'),
(242, 'TH10', 28, 28, 28, '2022-05-25', 1, 1, 1, 'MAQUINADO'),
(243, 'TH10', 28, 28, 28, '2022-05-25', 1, 1, 1, 'MAQUINADO'),
(244, 'TH10', 28, 28, 28, '2022-05-26', 1, 1, 1, 'MAQUINADO'),
(245, 'TH10', 28, 28, 28, '2022-05-26', 1, 1, 1, 'MAQUINADO'),
(246, 'TH10', 47, 47, 47, '2022-05-26', 1, 1, 1, 'MAQUINADO'),
(247, 'TH10', 28, 28, 28, '2022-05-26', 1, 1, 1, 'MAQUINADO'),
(248, 'TH10', 28, 28, 28, '2022-05-30', 1, 1, 1, 'MAQUINADO'),
(249, 'TH10', 35, 35, 35, '2022-05-30', 1, 1, 1, 'MAQUINADO'),
(250, 'TH10', 17, 17, 17, '2022-05-30', 1, 1, 1, 'MAQUINADO'),
(251, 'TH10', 25, 25, 25, '2022-05-30', 1, 1, 1, 'MAQUINADO'),
(252, 'TH17', 25, 25, 25, '2022-05-30', 1, 1, 1, 'MAQUINADO'),
(253, 'TH10', 19, 19, 19, '2022-05-30', 1, 1, 1, 'MAQUINADO'),
(254, 'TH10', 18, 18, 18, '2022-06-14', 1, 1, 1, 'MAQUINADO'),
(255, 'TP01', 600, 600, 600, '2024-01-10', 1, 1, 1, 'PRENSA'),
(256, 'TP01', 600, 600, 600, '2024-01-10', 1, 1, 1, 'PRENSA'),
(257, 'TH17', 31, 2, 2, '2024-01-10', 1, 1, 1, 'MAQUINADO'),
(258, 'TH17', 31, 2, 2, '2024-01-10', 1, 0, 1, 'MAQUINADO'),
(259, 'TP11', 735, 735, 735, '2024-01-17', 1, 1, 1, 'PRENSA'),
(260, 'TP11', 735, 735, 735, '2024-01-17', 1, 1, 0, 'PRENSA'),
(261, 'TP11', 600, 600, 600, '2024-01-17', 1, 1, 1, 'PRENSA'),
(262, 'TP11', 735, 735, 735, '2024-01-17', 1, 1, 1, 'PRENSA'),
(263, 'TP11', 734, 734, 734, '2024-01-17', 1, 1, 1, 'PRENSA'),
(264, 'TP11', 600, 600, 600, '2024-02-12', 1, 1, 1, 'PRENSA');
...
(160, 'Liliana Guadalupe', 'Diosdado', 394, '#4140991369#', 'Keeper', 1, 0, 2),
...
INSERT INTO `registrocausasparo` (`idregistrocausasparo`, `empleado_idempleado`, `causas_paro_idcausas_paro`, `tiempo`, `detalle`, `hora_inicio`, `fecha`, `linea`, `das_id_das`, `mog_idmog`) VALUES
(1, 746, 99, 26, '', '07:58', '2020-11-19', 'TP10', 53, 58),
(2, 145, 94, 27, '', '08:24', '2020-11-19', 'TP01', 54, 59),
(3, 746, 103, 22, 'BREAK ', '10:30', '2020-11-19', 'TP10', 55, 58),
(4, 145, 100, 28, '', '11:36', '2020-11-19', 'TP01', 56, 59),
(5, 746, 96, 40, '', '12:05', '2020-11-19', 'TP10', 55, 58),
(6, 149, 73, 22, '', '08:14', '2020-11-21', 'TP01', 57, 60),
(7, 149, 90, 15, '', '08:54', '2020-11-21', 'TP01', 58, 60),
(8, 148, 96, 28, '', '10:34', '2020-11-21', 'TP41', 60, 61),
(9, 149, 103, 28, 'BREAK', '10:55', '2020-11-21', 'TP01', 58, 60),
(10, 743, 100, 40, '', '13:41', '2020-12-08', 'TP41', 89, 77),
(11, 740, 73, 66, '', '07:17', '2020-12-18', 'TP41', 106, 85),
(12, 66, 36, 26, 'E AJUSTE INICIAL', '11:17', '2021-08-03', 'TH02', 175, 128),
(13, 66, 24, 122, '', '11:43', '2021-08-03', 'TH02', 175, 128),
(14, 69, 8, 23, '', '08:40', '2021-08-04', 'TH13', 176, 129),
(15, 131, 25, 26, '', '09:44', '2021-08-18', 'TH03', 181, 139),
(16, 42, 9, 12, '', '11:11', '2021-08-19', 'TH10', 185, 141);
...
--
ALTER TABLE `empleado`
  MODIFY `id_empleado` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=761;
...
--
ALTER TABLE `registro_x_hora`
  MODIFY `id_registro_x_hora` int(11) NOT NULL AUTO_INCREMENT;
