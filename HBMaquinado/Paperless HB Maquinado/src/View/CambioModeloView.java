 ...
 */
public class CambioModeloView extends javax.swing.JFrame {

    /**
     * Creates new form CambioModeloView
     */
    private CambioModeloView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cambio de Modelo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CambioModeloView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CambioModeloView().setVisible(true);
            }
        });
    }
