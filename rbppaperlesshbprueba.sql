...
--
-- Servidor: localhost
-- Tiempo de generación: 17-02-2025 a las 11:24:52
...
--
ALTER TABLE `das`
  MODIFY `id_das` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=207;
...
--
ALTER TABLE `piezas_x_hora`
  MODIFY `id_piezas_x_hora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `registro_causas_paro`
  MODIFY `id_registro_causas_paro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tiempos`
  MODIFY `id_tiempos` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=202;
